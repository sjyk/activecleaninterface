...
from learn.Pipeline import ActiveClean
	...
	text_file = open("/var/www/html/activecleandemo/activeclean/generated.py", "w")
	text_file.write(s)
	text_file.close()

	subprocess.check_call(['python', '/var/www/html/activecleandemo/activeclean/generated.py'], cwd='/var/www/html/activecleandemo/activeclean/')
